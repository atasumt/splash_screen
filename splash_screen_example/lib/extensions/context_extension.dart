...
extension ContextExtension on BuildContext {
  ...
  double responsive(double size, {Axis axis = Axis.vertical}) {
    final currentSize = axis == Axis.horizontal ? screnSize.width : screnSize.height;
    final designSize = axis == Axis.horizontal ? designScreenSize.width : designScreenSize.height;
